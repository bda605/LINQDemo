...
namespace LINQDemo
{
    public partial class LINQ23 : Form
    {
        public LINQ23()
        {
            InitializeComponent();
        ...
        private void LINQ23_Load(object sender, EventArgs e)
        {
            List<string> stringsold = new List<string>();
            stringsold.Add("A");
            stringsold.Add("B");
            List<string> stringsoldNew = new List<string>
            {
                "A",
                "B"
            };
            ...
            contactold.FirstName = "A";
            contactold.LastName = "B";
