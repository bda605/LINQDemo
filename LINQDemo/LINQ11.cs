...
namespace LINQDemo
{
    public partial class LINQ11 : Form
    {
        public LINQ11()
        {
            InitializeComponent();
        ...
        private void LINQ11_Load(object sender, EventArgs e)
        {
            ...
            //contacts.Sort( delegate (Contact t1, Contact t2) 
            ...
            foreach (KeyValuePair<string, List<Contact>> group in groups)
            {
